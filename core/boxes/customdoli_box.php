 ...
 */
class customdolibox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "customdoli@customdoli";
    public $boxlabel;
    public $depends = array("customdoli");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/customdoli/class/customdoli.class.php";
